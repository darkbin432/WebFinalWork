	...
	E.config.uploadImgFns = {
		onload:function (resultText,xhr) {
			...
			if (resultText.msg=="上传失败") {
				...
				img.onload = function () {
					var html = '<img src="http://localhost:8090/WebFinalWorkResource/images/'+resultText.data.fileName+'" alt="' +resultText.data.fileName+ '" style="max-width:100%;"/>';
				...
				img.src = "http://localhost:8090/WebFinalWorkResource/images/"+resultText.data.fileName;
            }
