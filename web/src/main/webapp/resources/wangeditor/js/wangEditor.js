...
_e(function (E, $) {
    ...
    MenuContainer.fn._addGroup = function (groupIdx) {
        ...
        if (!this.$currentGroup || this.currentGroupIdx !== groupIdx) {
            $menuGroup = $('<div class="menu-team clearfix"></div>');
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        // editor.commandHooks.fontSize = function (value) {
        //     var rangeElem = editor.getRangeElem();
        //     var targetElem = editor.getSelfOrParentByName(rangeElem, 'p,h1,h2,h3,h4,h5,pre,a,div');
        //     if (!targetElem) {
        //         return;
        //     }
        //     var str = value + 'px';
        //     $(targetElem).css('fontSize', str);
        // };
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        */
        ...
        menu.updateSelectedEvent = function () {
            var rangeElem = editor.getRangeElem();
            rangeElem = editor.getSelfOrParentByName(rangeElem, 'h1,h2,h3,h4,h5,h6');
            if (rangeElem) {
                return true;
            }
            return false;
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $btnSubmit = $('<button class="rightButton">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="rightButton gray">' + lang.cancel + '</button>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $linkInput = $('<input type="file" class="hidden">')
        var $linkIcon = $('<div class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></div>');
        $linkInputContainer.append($linkIcon);
        ...
        $linkInput.change(function (e) {
            ...
            $.ajax({
                ...
                contentType: false,
                processData: false,
                xhr:xhrOnProgress(function(){
                }),
                success: function (data) {
                    if (data.status == 200) {
                        var imgHtml='<p><video src="'+videoPath+data.data.fileName+'" controls style="height: 200px;"></video><br></p>';
                        editor.command( e,'insertHtml', imgHtml, callback);
                    }
                    $linkInput.val('')
                },
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $clearBtn = $('<button class="rightButton link">' + lang.clearLocation + '</button>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $linkBtnSubmit = $('<button class="rightButton">' + lang.submit + '</button>');
        var $linkBtnCancel = $('<button class="rightButton gray">' + lang.cancel + '</button>');
