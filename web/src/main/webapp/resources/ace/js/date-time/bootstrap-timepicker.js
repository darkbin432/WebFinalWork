...
(function($, window, document) {
  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.showWidgetOnAddonClick && (this.$element.parent().hasClass('input-team') && this.$element.parent().hasClass('bootstrap-timepicker'))) {
        this.$element.parent('.input-team.bootstrap-timepicker').find('.input-team-addon').on({
