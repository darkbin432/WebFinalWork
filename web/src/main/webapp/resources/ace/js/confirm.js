var Confirm = {
    ...
    addCustomButtons: function() {
        ...
        if (self.customButton)
            closeButton = '<button id="modal-close" type="button" class="btn btn-default modal-custom-button">否</button>';
        else {
            self.customButton = {
                'OK': {
                    'primary': true,
